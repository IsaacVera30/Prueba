...
try:
    ...
    else: print("Advertencia: Uno o ambos modelos de ML no se encontraron.")
...
def get_google_drive_service():
    ...
    if not os.path.exists(effective_key_file_location): print(f"⚠Drive: '{effective_key_file_location}' no encontrado."); return None
    try:
...
def get_ultima_medicion():
    global autorizado, capturando_entrenamiento
    ultima_estimacion["modo_autorizado"] = autorizado 
    ultima_estimacion["capturando_entrenamiento"] = capturando_entrenamiento
